...
namespace FarseerPhysics.Dynamics.Joints
{
    ...
    public class PrismaticJoint : FarseerJoint
    {
        ...
        private FVector2 m_axis, m_perp;
        ...
        public float JointTranslation
        {
            get
            {
                ...
                FVector2 axis = BodyA.GetWorldVector(ref _localXAxisA);
        ...
        public float JointSpeed
        {
            get
            {
                ...
                FVector2 p1 = BodyA.Sweep.C + r1;
                FVector2 p2 = BodyB.Sweep.C + r2;
                FVector2 d = p2 - p1;
                FVector2 axis = BodyA.GetWorldVector(ref _localXAxisA);

                FVector2 v1 = BodyA.LinearVelocityInternal;
                FVector2 v2 = BodyB.LinearVelocityInternal;
                float w1 = BodyA.AngularVelocityInternal;
                float w2 = BodyB.AngularVelocityInternal;

                float speed = FVector2.Dot(d, MathUtils.Cross(w1, axis)) +
                              FVector2.Dot(axis, v2 + MathUtils.Cross(w2, r2) - v1 - MathUtils.Cross(w1, r1));
                return speed;
            }
        }
